...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Fantastic results. I have had a number of cars remapped by Paul over many years. Recently he remapped my Mercedes C Class, immediately the performance was improved. Previously the cars performance was lacking at times particularly when overtaking, but now the car just fells like it wants to go and is fun to drive. ",
    name: "Nigel Caunt",
  },
